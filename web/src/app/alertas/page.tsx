...
export default function AlertasPage() {
  ...
  return (
    <>
      {/* Action bar */}
      <div className="flex items-center justify-end gap-3 px-4 sm:px-6 lg:px-8 py-3 border-b border-slate-100">
        <button
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-slate-100 rounded-xl text-slate-600 transition-colors"
          >
            ...
            <div className="mb-6 flex flex-col sm:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-slate-100 border border-slate-200 rounded-xl text-slate-900 placeholder-gray-500 focus:outline-none focus:border-green-500/50"
                />
              </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-4">
                            <div>
                              <h3 className={`font-semibold ${!alert.read ? 'text-slate-900' : 'text-slate-600'}`}>
                                {alert.title}
                              </h3>
                          ...
                          <div className="flex items-center gap-2 mt-4">
                            {!alert.read && (
                              <button
                                ...
                                className="flex items-center gap-2 px-3 py-1.5 bg-white hover:bg-slate-100 rounded-lg text-slate-500 text-sm transition-colors"
                              >
                            ...
                            <button
                              ...
                              className="flex items-center gap-2 px-3 py-1.5 hover:bg-red-500/20 rounded-lg text-slate-500 hover:text-red-400 text-sm transition-colors ml-auto"
                            >
