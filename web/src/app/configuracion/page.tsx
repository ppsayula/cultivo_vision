            ...
            <div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-orange-300">Sistema de Recordatorios</p>
                    <p className="text-sm text-orange-400/70 mt-1">
                      Los recordatorios se envian automaticamente de Lunes a Viernes a las 6:00 PM
                      a los usuarios que no hayan subido informacion durante el dia.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-blue-300">Reporte Automatico</p>
                    <p className="text-sm text-blue-400/70 mt-1">
                      El reporte diario se genera y envia automaticamente al administrador
                      todos los dias a las 8:00 PM con el resumen de actividades.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="bg-gray-800/50 border border-gray-700/30 rounded-lg p-4">
                      ...
                      <p className="text-2xl font-bold text-red-400">{todayReport.alerts_generated}</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-800/50 border border-gray-700/30 rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="text-center p-4 bg-green-500/10 rounded-lg">
                        <p className="text-3xl font-bold text-green-400">{todayReport.total_growth_records}</p>
                        <p className="text-sm text-green-300 mt-1">Registros de Crecimiento</p>
                      </div>
                      <div className="text-center p-4 bg-blue-500/10 rounded-lg">
                        <p className="text-3xl font-bold text-blue-400">{todayReport.total_photos}</p>
                        <p className="text-sm text-blue-300 mt-1">Fotos Subidas</p>
                      </div>
                      <div className="text-center p-4 bg-purple-500/10 rounded-lg">
                        <p className="text-3xl font-bold text-purple-400">{todayReport.total_lab_analyses}</p>
                        <p className="text-sm text-purple-300 mt-1">Analisis de Lab</p>
                      </div>
                    </div>
                  </div>
                </div>
